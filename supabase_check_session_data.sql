-- =============================================================================
-- SUPABASE: Verificar Dados de Sessões
-- =============================================================================
...
-- 3) Verificar user_measurements
-- Nota: collection_handle pode não existir nesta tabela
SELECT 
...
-- 6) Verificar se há shop_domain específico
...
-- 7) Verificar user_id específico (se souber)
-- Substitua o UUID pelo user_id da sua loja
SELECT 
  user_id,
  COUNT(*) as total,
