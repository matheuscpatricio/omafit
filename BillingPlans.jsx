...
/**
 * Componente de listagem de planos do Omafit.
 * Este é um stub (versão simples) – a lógica real de planos/billing
 * pode ser conectada depois usando props ou hooks.
 */
export default function BillingPlans({
  ...
  // Valores padrão, caso nada seja passado via props
    ...
    <BlockStack gap="400">
      ...
      <BlockStack gap="400">
        {effectivePlans.map((plan) => {
          const isCurrent = currentPlan && currentPlan === plan.name.toLowerCase();
