/**
 * Normaliza orientação do GLB (óculos) no Node, alinhado ao `workers/ar-eyewear-tripo/postprocess.py`
 * (`_snap_to_best_right_angle`): largura em X, espessura em Y, profundidade em Z — mesmo quando a
 * geração é FAL no servidor (sem passar pelo worker Python).
 */
...
/**
 * Rotação Rx → Ry → Rz em graus (mesma ordem que o loop em postprocess._snap_to_best_right_angle).
 */
